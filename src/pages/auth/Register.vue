...
const validation = computed(() => ({
  email:
    isEmail(regStore.formData.email) || isRequired(regStore.formData.email),
  password:
    isPassword(regStore.formData.password) ||
    isRequired(regStore.formData.password),
  tgAccount:
    isTelegram(regStore.formData.tgAccount) ||
    isRequired(regStore.formData.tgAccount),
  phone:
    isPhone(regStore.formData.phone) || isRequired(regStore.formData.phone),
  companyINN:
    isINN(regStore.formData.companyINN) ||
    isRequired(regStore.formData.companyINN),
}))
